...
const translations = {
    fr: {
        ...
        tradingSectionTitle: 'Trading & Price Action',
        tradingSectionSubtitle: 'Méthode structurée, analyse du marché et discipline de risque.',
        tradingPriceAction: 'Trading & Price Action',
        tradingPriceActionText: 'Développement d’une approche de <strong>trading discrétionnaire</strong> orientée <strong>Price Action</strong> et <strong>Smart Money Concepts (SMC)</strong>, principalement appliquée à <strong>l’or (XAUUSD)</strong> en scalping.<br><br>• Analyse de la structure du marché : tendance, BOS, CHoCH et points de retournement.<br>• Identification des zones de support/résistance, liquidité et Order Blocks.<br>• Travail sur le journal de trading, le backtesting et l’amélioration de la stratégie.<br>• Gestion du risque avec un RR minimum de 1:2, protection du capital et discipline.<br><br><strong>Objectif :</strong> construire une méthode structurée, testée et reproductible, plutôt que de trader sur l’intuition.',
        finance: 'Finance',
    ...
    en: {
        ...
        tradingSectionTitle: 'Trading & Price Action',
        tradingSectionSubtitle: 'Structured method, market analysis and risk discipline.',
        tradingPriceAction: 'Trading & Price Action',
        tradingPriceActionText: 'Development of a <strong>discretionary trading</strong> approach focused on <strong>Price Action</strong> and <strong>Smart Money Concepts (SMC)</strong>, mainly applied to <strong>gold (XAUUSD)</strong> in scalping.<br><br>• Market structure analysis: trend, BOS, CHoCH and reversal points.<br>• Identification of support/resistance zones, liquidity and Order Blocks.<br>• Work on trading journal, backtesting and strategy refinement.<br>• Risk management with a minimum RR of 1:2, capital protection and discipline.<br><br><strong>Goal:</strong> build a structured, tested and repeatable method rather than trading on intuition.',
        finance: 'Finance',
